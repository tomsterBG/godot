...
func test():
	...
	test_property_signature("A", A as MyGDScript, true)
	test_property_signature("B", B as MyGDScript, true)
	test_property_signature("C", C as MyGDScript, true)
	print("=== Member Properties ===")
	test_property_signature("B", b)
	test_property_signature("C", c)
	print("=== Class Methods ===")
	test_method_signature("A", A as MyGDScript)
	test_method_signature("B", B as MyGDScript)
	test_method_signature("C", C as MyGDScript)
